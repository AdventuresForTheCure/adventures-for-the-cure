...
userEditCtrl.$inject = ['$scope', '$route', '$location', 'notifierService', 'userService', 'identityService'];
function userEditCtrl($scope, $route, $location, notifierService, userService, identityService) {
